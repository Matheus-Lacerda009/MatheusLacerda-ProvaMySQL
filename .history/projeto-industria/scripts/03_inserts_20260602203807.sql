...
insert into Categoria_Produto(tipo_categoria) values
...
insert into Produtos(nome, descricao, preco_fabricacao, quantidade_estoque, codigo, id_categoria, id_fornecedor) values
('Chapa metálica', null, 100, 5, 1, 1, 1),
('Parafuso 5mm', 'Parafuso com o diâmetro de 5 mm', 5, 100, 2, 2, 2),
('Pistão', 'Pistão hidráulico', 300, 8, 3, 3, 3),
('Volante', null, 50, 20, 4, 4, 4),
('Arduíno', null, 20, 150, 5, 5, 5),
('Cano de aço', null, 100, 5, 6, 1, 1),
('Parafuso 10mm', 'Parafuso com o diâmetro de 10 mm', 5, 100, 7, 2, 2),
('Prensa', 'Prensa hidráulico', 300, 8, 8, 3, 3),
('Mídia', null, 50, 20, 9, 4, 4),
('ESP32', null, 20, 150, 0, 5, 5);
...
(null, 5, 2, 72, 10, 1, 1),
(null, 50, 1, 96, 0, 2, 2),
('2001-02-03', 10, 3, 0, 50, 5, 3),
('2002-03-04', 100, 3, 0, 60, 6, 4),
('2003-04-05', 3, 3, 0, 70, 7, 5),
(null, 30, 2, 72, 20, 1, 6),
(null, 6, 1, 96, 0, 2, 7),
('2004-02-03', 60, 3, 0, 80, 8, 8),
('2005-03-04', 8, 3, 0, 90, 9, 9),
('2006-04-05', 80, 3, 0, 100, 10, 10),
(null, 9, 2, 72, 30, 3, 1),
(null, 90, 1, 96, 0, 4, 2),
('2007-02-03', 7, 3, 0, 50, 10, 3),
('2008-03-04', 70, 3, 0, 60, 1, 4),
('2009-04-05', 25, 3, 0, 70, 1, 5);
